...
\begin{wrapfigure}[13]{r}{0.61\textwidth}
  \centering{\includegraphics[width=0.61\textwidth]{Figures/domain.pdf}}
    \vspace{-20pt}
...
be ignored since they, like the rates of biological functions like fusion,
fission, and pore dynamics, determine rely on viscous
