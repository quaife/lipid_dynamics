...
and bind nano-legos in a solvent \cite{Pandey2011, Leong2007, Reynolds2019,
Dasgupta2017, Siontorou2017}. Additionally, hydrodynamic interactions are central for complex
microscopic three-dimensional structures to fabricate~\cite{Cho2010}.
%
In Specific Aim 2, we propose to develop efficient high-order numerical methods to simulate dynamic
assembly of particles under HAP potential in a viscous solvent. 
%
%
...
%
As described in~\eqref{eq:stokes} and
...
Numerical methods to solve BIEs have
