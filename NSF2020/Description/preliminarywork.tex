...
\vspace{-5pt}
  ...
  \caption{\label{fig:tank_treading} \footnotesize
    ...
    $\dot{\gamma} = 0.5$ $\mu$s$^{-1}$. (Compare with \cite{Brandner2019}).
    Panel B: Angular velocities for the outer and the inner leaflets.
    Panel C: The trajectory of the particle
    centers forms two ellipses with well-defined inclination angle
...
velocities. The measured steady-state freque ncies were within 7\% of the predicted 
