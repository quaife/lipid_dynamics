...
The Gradient Theory of Phase Transitions and the Minimal Interface Criterion. Arch. Rational Mech. Anal. 98 (1986) 123–142.
...
PI RR has worked directly on phase field approximations of membrane bending energy \cite{Willmore} and asymptotcs in the Poisson-Boltzman equation \cite{LeeRyham}.
...
\cite{Stephan Luckhaus & Luciano Modica}, which is an essential benchmark for numerical validation. 
