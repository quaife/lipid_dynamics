...
To measure the twise modulus, we place a single monolayer on a hydrophobic substrate 
...
We will develop some of the mathematical connections between the HAP energy and the energy functional used in the phase field method. 
...
\cite{The Gradient Theory of Phase Transitions and the Minimal lnterfaee Criterion, }. 
Analogously, the HAP energy converges to the surface energy in the limit
$\rho \to 0$, and the boundary layers of the minimizers (the solutions to the screen Laplace equation) converges to 
area measures supported on the particle boundaries. We will use boundary layer analysis to study the rate
of convergence as it depends on \cite{Stephan Luckhaus & Luciano Modica, LeeRyham} 
