...
We propose to conduct calculations similar to the example of Figure~\ref{fig:flattening} for other elastic moduli such as the effective twist modulus $\KT$.
...
screening length and the boundary layers of the minimizers (the
solutions to the screen Laplace equation) converges to area measures
supported on the particle boundaries. This is analogous to the sharp
interface limit in the phase-field functional
formulation~\cite{Modica87, MODICA1987487, LuMo89}. PI RR has worked
directly on phase field approximations of membrane bending
energy~\cite{0951-7715-18-3-016} and asymptotcs in the Poisson-Boltzman
equation~\cite{1531-3492_2006_2_357, Lee2018}. The proposed analysis is
...
problem~\cite{Modica87, MODICA1987487, LuMo89}. 
%
%
One of the basic questions is to establish the HAP convergence rate as a
