...
\end{wrapfigure}
%
researchers to question the applicability of \eqref{ansatz3} \todo{this
equation hasn't been presented at this point} for large curvatures
\cite{PhysRevLett.117.188102, ARGUDO20161619}. For example, Galimzyanov
{\em et al.}~\cite{C9SM02079A} countered that energies derived from
molecular dynamics and elasticity agree, even when curvatures are large.
