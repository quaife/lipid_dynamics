...
%
\begin{wrapfigure}[9]{r}{0.43\textwidth}
\vspace{-0.4cm}
\centerline{\includegraphics[width=0.43\textwidth]{Figures/Flattening.pdf}}
%  \centering{\includegraphics[width=0.80\textwidth]{Figures/Deformations.pdf}}
\vspace{-0.5cm}
...
%\subsubsection{Asymptotic analysis on the limit $\rho\rightarrow 0$ of
%HAP}
