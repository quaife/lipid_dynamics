...
The substantial free energy of placing hydrophobic surfaces in
...
hyperbolic trigonometric functions and ready \todo{What is 'and ready'?}
...
\begin{wrapfigure}[8]{r}{0.32\textwidth}
  ...
  attraction in terms of the free energy of voids
  \cite{Lum1999}.}
\end{wrapfigure}
\todo{This figure is not referenced in the text.}
...
by the theory~\cite{Ni80}. \todo{This last sentence is confusing and I'm
...
In terms of applications, the approach \todo{what approach} resolves
