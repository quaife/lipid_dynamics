...
\todo[inline]{BQ: Also will have the new Allen-Cahn type equation}
...
equation~\eqref{eqn:???} will be iteratively solved using BIE
formulations.
...
\label{subsec:AC}
\todo[inline]{Write once the model is finalized}
