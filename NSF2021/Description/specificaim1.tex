...
relative orientation of nearby particles.
The single peak and broad tails for the blue curve indicates a bilayer structure.
The bimodal red curve indicates multilamellar monolayers. Finally,
The yellow distribution has peaks at $\pm 45^{\circ}$ 
indicating a checkboard pattern. 
As another example, Janus particles
