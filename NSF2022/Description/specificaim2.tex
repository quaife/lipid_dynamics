...
\eqref{eqn:conv}, where $G(\xx - \yy)$  takes the form
$-(2\pi \epsilon_0)^{-1}\log|\xx - \yy|$
in two dimensions and 
$(4\pi \epsilon_0)^{-1}|\xx -\yy|^{-1}$ in three dimensions
with $\epsilon_0$ the permittivity of vacuum.  In
