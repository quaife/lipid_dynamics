...
$\phi^{N+1} = \phi^{N} - \xi (F'(\phi^N))^{-1} F(\phi^N)$, where
$F'(\phi^N) = -\epsilon^2 \Delta + W''(\phi^N)$ is the Fr\'{e}chet
derivative of $F$, and $\xi$ is the step size that will be determined
