...
PIs' recent results in \cite{FuEtAl2022_arXiv} show that these patterns may be understood by a mixture of polar and nematic characteristics of the individual Janus particle, tuned by the boundary condition $g({\bf x})$. Based on this hypothesis, a natural question is to see if the collective dynamics of Janus particles with different boundary conditions can be predicted by a coarse-grained model based on the kinetic theory?
