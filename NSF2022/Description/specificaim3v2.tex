...
%\end{wrapfigure}
%%
Case (a) models amphiphilic granules.
...
$D_x$ is the translational diffusion and $D_p$ is the rotational diffusion. 
 ${\bf F}\left(\phi,{\bf d}\right)$ and ${\bf G}\left(\phi,{\bf d}\right)$ are the drift and rotation induced by the potential $\eta$ and alignment, respectively.
