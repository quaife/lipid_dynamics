...
by integrating over the whole domain the stress from the single particle weighted by the density distribution $\psi$ \cite{TraversoMichellin2020_PRF,TraversoMichellin2022_JFM}.
