\subsection{Specific Aim 3: Coarse-grain modeling of self-assembled granules}
...
In~\cite{fu-ryh-qua-you2022},  the PIs investigated how changes
...
constraint forces (amphiphilic granules cannot overlap with each
other, see \cite{Weady2022_PRF}) as part of the active stress in the Stokes equations
for the suspension. 
%Such constraint forces arise from the condition
