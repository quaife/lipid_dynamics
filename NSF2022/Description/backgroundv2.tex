...
clumsy to incorporate in the model.
Moreover, numerical simulations of phase field models typically discretize
the entire fluid domain under
...
Modeling procedure.
We initialize a suspension of granules.
