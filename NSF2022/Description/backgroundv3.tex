...
\begin{wrapfigure}[10]{l}{0.48\textwidth}
\vspace{-5pt}
...
\end{align}
Here $E$ is the energy stored by the phase transitions between the
granule boundaries and the solvent and the energy law states that the
granules move to decrease energy, which is lost due to viscous
