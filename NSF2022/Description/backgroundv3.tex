...
\begin{wrapfigure}[21]{r}{3.2in}
  ...
  on one side and $\phi = 1$ (yellow) on the other form multilamellar
  bilayers.  (\emph{Bottom}) Bipolar granules with $\phi = 1$ (yellow)
  on one side and $\phi=-1$ (green) on the other side form a
