...
interaction kernels to study agent-based systems like swarms
...
to emphasize the role played by elliptic equations and the granules'
finite size.
...
(ii) The model formulation is built around important details
...
%    \includegraphics[keepaspectratio,height=2.7cm]{figures/SpecificAim1/3Particles.jpg}
  ...
  velocity field. The granules reach an equilibrium state in panel (d).}
\end{figure}
...
agreement with those derived by atomistic and Martini force field simulation
