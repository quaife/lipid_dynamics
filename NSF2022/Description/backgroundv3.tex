...
\begin{wrapfigure}[17]{l}{4in} 
\includegraphics[width=4in]{figures/Background/coarsening.pdf}
\vspace{-20pt}
\caption{\label{fig:coarsening}
Energy $E$ in equation~(\ref{eq:energy_law}) of a suspension of amphiphilic granules versus time $t$.
...
External hydrodynamic effects are introduced to study elastic properties the the granules assembly \cite{Fu2018_SIAM,FuQuRyYo22}.
}
\vspace{5pt}
\end{wrapfigure}
