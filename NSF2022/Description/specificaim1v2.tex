...
autonomous ordinary differential equation for the body transformations
$\FF_i$ with the rate of change defined by a system of PDEs. Regarding
the PDE system, in the linear case and for fixed $t$, there is a unique
...
example. For global-in-time solutions, we can use lubrication
...
granules. Finally, we can study the granule-flow behavior in the
...
In the case of granules, bending enters through the
