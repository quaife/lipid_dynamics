...
\includegraphics[width=1.0\textwidth]{Figures/Figure9.pdf}    
  \end{center}
  \vspace{-20pt}  
  \caption{\label{fig:BC2_shear_flow} Multi-lamellar stracture in shear flows. The insets of Fig~\ref{fig:relax}c is used for panels (a). Panels (b)-(d) are snapshots when shear rates are $\dot\gamma=\{0.05, 0.1, 0.15\}$ at $t=600$, respecitively. The streamlines are plotted in the background.}
\end{figure}
