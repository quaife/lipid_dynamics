...
force and torque coming from the hydrophobic potential and repulsion \cite{Fu2022_JFM}.
To compute this balance, we define
the free energy\cite{Fu2022_JFM}
\begin{equation}
>>>>>>> e6ff8abf65732bc50432a8d6cd9352c76cb936ca
...
=======
The parameter $\rho_0$ is an ``effective" distance between particle centers,
below which the steric repulsion between a pair of JPs becomes important.

The order parameter $u(\xx,t)$ is assumed to the minimizer of the free energy $F$ \cite{Fu20}.
Its governing equations $u(\xx,t)$ 
are a screened Laplace equation boundary value problem
as a model for the hydrophobic interaction between water and JPs:
\begin{gather}
  \label{eq:SL}
...
To get forces and torques from the free energy,
...
The derivation details are found in \citet{Fu20}.
