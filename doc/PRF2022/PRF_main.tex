...
Following the formulation in \citep{Fu2022_JFM}, 
...
possibly opposite direction are ordered. A value below 1 indicates imperfect order, and zero indicates
complete disorder.
...
case of bilayers with multiple domains in TG flow
