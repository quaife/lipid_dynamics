...
\begin{figure}
  ...
  \caption{
    \label{fig:BC1_shear}
    A vesicle in shear flows with shear rates $\dot\gamma=\{0.05, 0.1\}$. We propose the order parameter defined by $S_{loc} = \frac12(3\cos(\theta-\bar\theta)^2-1)$}
\end{figure}
...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.24\textwidth]{shear_0.png}
  \includegraphics[width=0.24\textwidth]{shear_1000.png}
  \includegraphics[width=0.24\textwidth]{shear_2000.png} 
  \includegraphics[width=0.24\textwidth]{shear_2000.png} \\
  \end{center}
  \vspace{-20pt}  
