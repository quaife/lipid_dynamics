...
\begin{abstract}
  ...
  Focusing on a simple tuning of the hydrophobicity distribution,
  we found
  ...
  We characterized the effective material properties of the JP structures
...
relative to the horizontal axis, where $i = 1, \dots, N_b$ and $N_b$ is
