...
velocity, and $\langle x, y \rangle^{\perp} = \langle -y, x\rangle$. To
close the system \eqref{eq:stokes}-\eqref{eq:rigid-vel}, we use
\begin{equation}
  \label{eq:force}
...
To determine $\FF_i$ and $T_i$, the particles minimize the free energy
\begin{equation}
