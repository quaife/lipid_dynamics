...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.4\textwidth]{multilamellar_shear_Energy}
    \includegraphics[width=0.4\textwidth]{multilamellar_shear_MSD}
  \end{center}
...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.4\textwidth]{multilamellar_shear0p1_Energy_LsFs}
    \includegraphics[width=0.4\textwidth]{multilamellar_shear0p1_MSD_LsFs}
  \end{center}
...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.4\textwidth]{multilamellar_TG_Energy}
    \includegraphics[width=0.4\textwidth]{multilamellar_TG_MSD}
  \end{center}
...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.4\textwidth]{checker_board_shear_Energy}
    \includegraphics[width=0.4\textwidth]{checker_board_shear_MSD}\\
  \includegraphics[width=0.4\textwidth]{checker_board_shear0p125_OP}
    \includegraphics[width=0.4\textwidth]{checker_board_shear0p15_OP}
  \end{center}
...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.4\textwidth]{checker_board_TG_Energy}
    \includegraphics[width=0.4\textwidth]{checker_board_TG_MSD}\\
      \includegraphics[width=0.4\textwidth]{checker_board_TG0p2_OP}
    \includegraphics[width=0.4\textwidth]{checker_board_TG0p3_OP}
  \end{center}
...
collection of rigid Janus particles. The interactions satisfy a system
of partial differential equations (PDEs) that describe the hydrodynamic
interactions and hydrophobic interactions. Assuming inertial terms are
negligible, the solvent is goverened by the Stokes equations
\begin{alignat}{3}
\label{eq:stokes}
...
angular velocity. Once these quantities are determined, we use
...
\end{align}
%
where the number of particles $N_b$, the density function $\eeta$, translation velocity $\vv_i$ and angular velocity $\omega_i$ satisfy
