...
These are solved with matrix-free GMRES and the second-kind BIEs
guarantee that the number of GMRES iterations is mesh-independent.
...
Supplementary Figures~\ref{fig:ulshraw}--\ref{fig:sttgraw}
...
in Supplementary Figures~\ref{fig:ulshraw}--\ref{fig:sttgraw}
...
their time average over the interval $t \in [0, T]$. 
...
Supplementary Material Figures \ref{fig:ulshraw}--\ref{fig:sttgraw}). 
