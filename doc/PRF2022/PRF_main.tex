...
\item $N_b=60$ structures in a shear flow: For both boundary conditions, lamellar (FIG. 4) and polar (FIG. 4), convergence tests using $N=16$ and $N=24$ are not yet verified. 
