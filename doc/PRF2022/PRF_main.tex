...
\begin{abstract}
  ...
  background flow (JFM, 941, 2022). We investigate how various
  morphologies arise from tuning the hydrophobic distribution of the
  JP-solvent interface. We find JPs assembled into uni-lamella,
  multi-lamella and striated structures. To introduce dynamics, we
  include a linear shear flow and a steady Taylor-Green mixing flow, and
