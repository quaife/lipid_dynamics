...
\begin{figure}
  ...
  \end{center}
\caption{A vesicle in shear flows with shear rates $\dot\gamma=\{0.05, 0.1\}$. We propose the order parameter defined by $S_{loc} = \frac12(3\cos(\theta-\bar\theta)^2-1)$}
\end{figure}
...
\begin{figure}
  ...
  \end{center}
\caption{A vesicle in Taylor-Green flows when the flow strength $V_0=\{0.1,0.2\}$. }
\end{figure}
