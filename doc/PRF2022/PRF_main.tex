...
inversely proportional to screening length $\rho.$
...
strain are effective measures to quantitatively capture the dynamics of
the JP oligomers under a linear shear flow.
...
JPs oligomers behave as a shear-thinning fluid, while the striated (BC
(iii)) JPs oligomers possess a yield stress.
