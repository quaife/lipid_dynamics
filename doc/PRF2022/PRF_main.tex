...
In \eqref{eq:tg_flow}, $\lambda$ is the cell-size parameter.
...
was chosen for \eqref{eq:tg_flow} so that it has the same
...
\todo[inline]{Reference the supplementary material here.}
