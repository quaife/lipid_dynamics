...
Under a given flow, we use the three measures of deformations to quantify the differences in the collective dynamics between the three types of JPs.
...
Under a relatively weak linear shear flow, the amphiphilic (BC (i)) JPs behave as a unilamellar vesicle that elongates and tank-treads.
...
the cell in TG flow. On the other hand, the assembly of multi-lamella JPs and the striated JPs behaves more or less as a rigid body with connected subdomains, with the number of subdomains increasing with stronger strength of the TG flow.
