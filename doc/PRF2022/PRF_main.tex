...
\begin{figure}
  ...
  \end{center}
  \vspace{-20pt}  
  \caption{\label{fig:BTG_flow} The figure shows a vesicle in Taylor-Green flow (panel (a) shows the pre-relaxed initial configuration; panels (b)-(d): $V_0 = \{0.1, 0.15, 0.2\}$ at $t=600$) 
