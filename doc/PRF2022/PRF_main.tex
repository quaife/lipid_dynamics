...
energy normalization to study the collective dynamics of amphiphilic (BC
I), biased hydrophobic (BC II), and bipolar (BC III) JPs under various
flowing conditions (quiescent flow, linear shear flow, and Taylor-Green
flow). Three quantities are computed to characterize the dynamics of the
collective configurations of JPs: free energy $F$, strain parameter $E$,
and scalar order parameter $S_2$. 
%We quantify how
