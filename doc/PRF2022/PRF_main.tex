...
and decreasing the 
the tension parameters $\gamma$ and $M$ by up to 10\% (collectively denoted
...
Here $L$ is the diameter of the phase sample, which is proportional
to $\gamma^*$ since the striated phase tends to cleave during
rupture (see Supplementary Movie S4).
Our previous work\cite{Fu2022_JFM}
found the scaling $\mu \dot\gamma_* = K_{\text{I}} \gamma c^2/(\rho L^2)$
for vesicle BL in shear flow.
