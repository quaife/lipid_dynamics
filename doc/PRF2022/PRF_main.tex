...
As the shear rate increases to a moderate value (figure~\ref{fig:BC1_shear}(b)), the bilayer is observed to shed a small piece of bilayer, similar to the asymmetric breakup of a viscous drop \cite{}.
In figure~\ref{fig:BC1_shear}(c) the high shear rate gives rise to two nearly equal bilayers, similar to the symmetric drop breakup under a linear shear flow \cite{}.
%
\begin{figure}
  \begin{center}
