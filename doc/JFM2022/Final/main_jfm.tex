...
\caption{Panel (a) illustrates the domain and boundary conditions for
  ...
  $u$ of \eqref{eq:SL}. Red is for $\eta  = 1$ and blue is for $\eta  = 0$.
...
We select $M=4.0$~$\text{pN}$ and $\rho_0 = 0.2l_0$ so that \eqref{eq:REPULforce}
  prevents particle collisions and is comparable to hydrodynamic lubrication.
  With a slight modification, the appendix of
  \citep{cawthorn_balmforth_2010} provides the asymptotic expression 
...
%\begin{figure}
%\centering
%\includegraphics[width=11.32cm]{Figure8_Wrapper.eps}
%%\includegraphics[height=2in]{N58_rupt_0.eps}
%%\includegraphics[height=2in]{N58_rupt_200.eps}
%\\
%%\includegraphics[height=2in]{N58_rupt_400.eps}
%%\includegraphics[height=2in]{N58_rupt_600.eps}
...
\begin{figure}
  ...
  of $d_{1,2}$ generated by the continuum model and the thick curves are computed from using
  the proposed HAP model.}
\end{figure}


Since the behavior of the suspended JP vesicles has similarities to the numerical 
