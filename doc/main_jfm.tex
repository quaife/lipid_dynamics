...
The coefficients generally lie within the range 1 to 2 pN$\cdot$ns nm$^{-2}$ but there are some 
outliers.  These outliers ($\dot\gamma = 0.0025$ ns$^{-1}$ and 
$\dot\gamma = 0.0040$ ns$^{-1}$) correspond to slip velocities that are too low relative to shear rate (see the green and red curve in Figure \ref{figure5}: panel (c)).
