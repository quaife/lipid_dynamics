...
Table~\ref{table1} provides a series of numerical results for dimensional friction coefficients $b$ which are quantitatively close to literature such as ones in~\cite{sch-vla-mik2010} and~\cite{denOtter2007}. 

%As expected, within the same order, the friction coefficients are independent of the shear rates.
...
$b$ (pN$\cdot$ns nm$^{-2}$)    & 1.38 &  5.43 & 1.37 &  1.33 & 8.07 & 1.94  & 1.89\\ 
\hline    
\end{tabular} 
\label{table1}
\end{table}
