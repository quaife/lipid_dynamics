...
\ReviewerThree{
  ...
  \cite{cawthorn_balmforth_2010} provide the asymptotic expression 
  ...
  because the particle gaps smaller than the particle radius
...
The JP vesicle is somwhat hexagonal (see, e.g., Figure~\ref{figure5}a)
...
comes from the trank-treading of individual particles, that is
it corresponds to the rate of passage of particles through a fixed-angle
