...
Case 1. 58 particles with diameter 2.5 nm and $L_0 = 107$ nm. The calculated stretching modulus was $K_A = 179$ pN nm$^{-1}$ which gives 43.6 kT nm$^{-2}$.
...
Case 2. 119 particles with diameter 2.5 nm and $L_0 = 218$ nm. This data set gave  $K_A = 160$ pN nm$^{-1}$ which gives 39 kT nm$^{-2}$. For permeability we get 0.0283 $\mu$m s$^{-1}$ Pa$^{-1}$.
Case 3. 117 particles with diameter 1.25 nm and $L_0 = 141$ nm. This data set gave  $K_A = 102$ pN nm$^{-1}$ which gives 24.8 kT nm$^{-2}$ which is small.
