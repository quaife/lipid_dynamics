...
Table~\ref{table1} provides a series of numerical results for dimensional friction coefficients $b$ which are quantitatively close to literature~\cite{sch-vla-mik2010,denOtter2007}. 
