...
\ReviewerOne{As shown in Figure~\ref{figure2}\ReviewerOne{a}, the particle translational and angular velocities vanish during the relaxation as expected.}
...
%
Figure~\ref{figure2}\ReviewerOne{b} plots the data for the pressure jump $\Delta p$
between the particle centre and the far-field (see
Figures~\ref{figure2}\ReviewerOne{b} and~\ref{figure2}\ReviewerOne{c}). 
We use $R = L/(2\pi)$ for
