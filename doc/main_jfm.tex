...
hydrophobic interactions between lipids, and the hydrophobic force is derived and used for 
obtaining particle dynamics. The mobility problem using integral equation methods combining
the previously introduced HAPis adopted.
...
phenomena in tank-treading Janus-vesicle, asymmetric slipper shape in a parabolic flow, and the membrane rupture in a flow at high shear rate.

Inter-monolayer friction coefficients are then obtained and reported by calculating the pressure jumps 
with respect to the bilayer midplane.
...
practical approach. Other physical properties of the bilayer membrane such as ......
