...
Particles self-assemble into vesicle bilayers (panel (b)). In panel (c), 
the particles arrange along inner and outer leaflets. The curve $C_M$ is the midplane curve which has 
length $L$ and surrounds a region of area $A$.  Initially stretched vesicles relax to equilibrium 
with fluid flow across the bilayer. The study considers a single vesicle in shear flow (panel (d)) and other background flows
and considers vesicle interactions in background flows (panel (e)).}
\label{fig:figure0}
\end{figure}
