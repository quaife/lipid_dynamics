...
\begin{abstract}
  ...
  that has been shown to model lipid bilayer membranes. In addition they also interact with each other indirectly through the hydrodynamic interactions.
  ...
  interactions in shear and extensional flows. We find that the hydrodynamics of a  vesicle assembled from Janus particles
replicates the dynamics of an inextensible elastic vesicle.
