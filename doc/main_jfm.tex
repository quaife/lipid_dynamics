...
$\dd_i$, where the vectors $\aa_i$ and $\dd_i$ are the particle centre
...
\begin{equation}
U = \frac{1}{L}\int_{C_M}u_+(\mathbf{x})(1 - \delta \kappa) - v_-(\mathbf{x})(1 +  \delta \kappa) \, ds,
\end{equation}
...
which is in good quantitative agreement with values previously reported in the literature.
