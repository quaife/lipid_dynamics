...
the initial circular shape  and the deformed configuration of the vesicle after a period of time. The tank-treading behavior appears after obtaining the equilibrium state. 
% needs to add more details about inclination angle, tank-treading frequency,...etc.
