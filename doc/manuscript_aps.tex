...
At each time step, we examine the nearest grid points between each pair of boundaries. Within a specified distance $d$, we introduce a short range repulsive potential as follows
